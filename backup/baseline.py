...
files = ['stage_1_sample_submission.csv',
 'stage_1_train.csv',
 'stage_1_test_images',
 'stage_1_train_images']
INPUT_PATH = '//home/claudiovaliense/kaggle/rsna/'
...
print('numero de ids no treino: ', traindf.id.nunique())
...
print('Quantidade ids para teste: ', test_size)

print('proporcao treino e teste: ', train_size/test_size)

print('arquivo do treino', train_files[0:10])
...
print('space pixel, distribuicao: ')
...
print('espacamento entre o pixel', np.min(pixelspacing_w) * 512)
...
print('tamanho janelas', doc_windows.head(20))

doc_windows[doc_windows.win_width==doc_windows.win_width.median()]
print('dados sobre janela', doc_windows.describe())

print('quantile tamanho janela', np.quantile(window_widths, 0.95))

print('quantile centro janela', np.quantile(window_levels, 0.95))
